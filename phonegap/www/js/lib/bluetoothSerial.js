define('bluetoothSerial', function (require, exports, module) {
    module.exports = {
        ...
        list: function (success, failure) {
            cordova.exec(function (devices) {
                for (var i = devices.length - 1; i >= 0; i -= 1) {
                    devices[i].address = devices[i].address || devices[i].uuid;
                }
                success(devices);
            }, failure, "BluetoothSerial", "list", []);
        },
